    ...
    <div class="container">
        <div class="banner_inner_content">
            ...
            <ul>
                ...
                <li><a href="homestay-detail.php">Homestay Detail</a></li>
            </ul>
        </div>
    </div>
</section>
                        ...
                        <div class="book_room_box">
                            ...
                            <div class="book_table_item">
                                <div class="input-append">
                                    <input size="16" type="text" value="" placeholder="Full Name *" required>
                                </div>
                            </div>
                            <div class="book_table_item">
                                <div class="input-append">
                                    <input size="16" type="text" value="" placeholder="Email *" required>
                                </div>
                            </div>
                            <div class="book_table_item">
                                <div class="input-append">
                                    <input size="16" type="text" value="" placeholder="Mobile Number *" required>
                                </div>
                            </div>
                            <div class="book_table_item">
                                <div class="input-append">
                                    <input size="16" type="text" value="" placeholder="Telephone Number">
                                </div>
                            </div>
                            <div class="book_table_item">
                            ...
                            <div class="book_table_item">
                                <div class="row">
                                    <div class="input-append col-md-6">
                                        ...
                                        <input size="16" type="number" value="0" placeholder="" required>
                                    </div>
                                    <div class="input-append col-md-6">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="dp2">
                                <div class="our_menu_tab_inner">
                                    <ul>
                                        <li>
                                            <div class="pull-left">
                                                <p><i class="fa fa-caret-right" aria-hidden="true"></i> Forest safari</p>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="dp3">
                                <div class="our_menu_tab_inner">
                                    <ul>
                                        <li>
                                            <div class="pull-left">
                                                <p><i class="fa fa-caret-right" aria-hidden="true"></i> Thorpally (15kms)</p>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="dp4">
                                <div class="our_menu_tab_inner">
                                    <ul>
                                        <li>
                                            <div class="pull-left">
                                                <p><i class="fa fa-caret-right" aria-hidden="true"></i> TMudumalai &#45; 15kms</p>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="dp5">
                                <div class="our_menu_tab_inner">
                                    <ul>
                                        <li>
                                            <div class="pull-left">
                                                <p><i class="fa fa-caret-right" aria-hidden="true"></i> Check in - 12 noon and Check out - 11 am.</p>
