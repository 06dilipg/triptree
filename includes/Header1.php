...
<body>
        ...
        <div class="header_top">
           ...
           $res = $conn->query($sql);
            ...
            ?> 
                        ...
                        <a href="#"><i class="fa fa-phone"></i><?php echo $cnt_phno; ?></a>

                        <a href="#"><i class="fa fa-envelope-o"></i><?php echo $cnt_email; ?></a>
                <?php   }} ?>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav" style=" margin-left: 128px;">
                            ...
                            <li <?php if ($page=="About"): ?>
                              class="active"
                            <?php endif ?>><a href="about-us.php">About Us</a></li>

                            

       <li class="submenu dropdown <?php if($page=='Homestay'){echo 'active';}?>" >
    ...
    //$ads_image = array();
     ...
     <?php      }} ?> 
                             ...
                             <!-- Resort -->
                            <li class="submenu dropdown <?php if($page=='Resort'){echo 'active';}?>">
  ...
  <ul class="dropdown-menu"> 
    ...
    //$ads_image = array();
     ...
     <?php      }} ?> 
                             ...
                             <li class="submenu dropdown <?php if($page=='Happyfarms'){echo 'active';}?>">
    ...
    //$ads_image = array();
     ...
     <?php      }} ?> 
                           ...
                           <!--  <li><a href="">Happy Farms</a></li> -->
                            ...
                            <li class="<?php if($page=='Contactus'){echo 'active';}?>"><a href="contact-us.php">Contact Us</a></li>
