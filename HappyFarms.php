            ...
            <div class="col-md-8">
                ...
                <section id="gallery-con">
                    ...
                    <section id="gallery-main">
                        <img src="<?php echo $directory; echo $slider;?>" width="100%" style="width:100%" height="400px" />
                    </section>
                    
                    <?php    foreach($slider as $slider_all) { ?>
                    <section id="gallery-hidden">

                        <img src="<?php echo $directory; echo $slider_all;?>" width="100%" height="400px" />
