    ...
    <aside class="right-side">
            ...
            <section class="content-header">
               <ol class="breadcrumb">
                  ...
                  <li><i class="fa fa-dashboard"></i> Enquiry Details </li>
                        ...
                        <div class="col-xs-12">
                           <div class="box">
                              <div class="box-header">
                                 <h3 class="box-title"><b> <i class="fa fa-envelope" style="font-size:17px;"></i> Enquiry Details</b></h3>
        ...
        $(function() {
            ...
            {  
                    ...
                    $.ajax({
                        ...
                        url:"<?php echo base_url(); ?>Admin/viewEnquiry?id=<?php echo $id;?>",
                        method:"POST",
