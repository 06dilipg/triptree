                  ...
                  <div class="col-xs-12">
                     <div class="box">
                        <div class="box-header">
                           <div class="col-md-6 ">
                              <h3 class="box-title pull-left"><i class="fa  fa-picture-o"></i>Banner Sliders Details</h3>
                           </div>
                           <div class="col-md-6">
         ...
         <div class="modal-dialog modal-lg" >
            <div class="modal-content ">
               <div class="modal-header blue_bg">
                  ...
                  <h4 class="modal-title white"><i class="fa fa-pencil-square-o"></i>Add  Banner Slider Details</h4>
               </div>
           <form id="locationForm" method="post" action="<?php echo base_url(); ?>Admin/Banner_add" enctype="multipart/form-data">
                  <div class="modal-body">
                      <div class="col-md-12">
                           <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Title Name*:</label>
                                        <input type="text" name="name" class="form-control" placeholder="Enter title for banner" required="required">
                                     </div>
                           </div>
                           <div class="col-md-12">
                                 <div class="form-group">
