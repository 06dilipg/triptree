<aside class="right-side">
            ...
            <section class="content-header">
               <ol class="breadcrumb">
                  ...
                  <li><i class="fa fa-dashboard"></i> Edit Cms Home  </li>
                        ...
                        <div class="col-xs-12">
                           <div class="box">
                              <div class="box-header">
                                 <h3 class="box-title"><b><i class="fa fa-edit"></i> Edit Cms Home </b></h3>
           ...
           CKEDITOR.replace('editor1');
            ...
            {  
                  ...
                  $.ajax({
                              ...
                              url:"<?php echo base_url(); ?>Admin/fetch_cmshme?id=<?php echo $id;?>",
                              method:"POST",
                              dataType:"json",
                           
                                  success:function(data){
                                            $('#title').val(data.home_title);
                                            $("#subtitle").val(data.home_subtitle);
                                            $("#editor1").val(data.home_description);
