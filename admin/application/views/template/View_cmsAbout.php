    ...
    <aside class="right-side">
            ...
            <section class="content-header">
               <ol class="breadcrumb">
                  ...
                  <li><a href="<?php echo base_url();?>View_location"><i class="fa fa-dashboard"></i> View About Details </a></li>
                        ...
                        <div class="col-xs-12">
                           <div class="box">
                              <div class="box-header">
                                 <h3 class="box-title"><b> <i class="fa fa-envelope" style="font-size:17px;"></i>CMS  About Page</b></h3>
        ...
        $(function() {
            ...
            {  
                    ...
                    $.ajax({
                        ...
                        url:"<?php echo base_url(); ?>Admin/view_cmsAbout?id=<?php echo $id;?>",
                        method:"POST",
