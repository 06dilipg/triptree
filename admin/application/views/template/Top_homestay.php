         ...
         <aside class="right-side">
            ...
            <section class="content-header">
               ...
               <ol class="breadcrumb">
                  ...
                  <li class="active">Top Featured</li>
               </ol>
            </section>
            <!-- Main content -->
                     ...
                     <div class="box">
                        <div class="box-header">
                           ...
                           <table>
                              ...
                              <h3 class="box-title pull-left"><i class="fa fa-user"></i> Top Featured</h3>
                           </div>
                           <div class="col-md-6">
         ...
         <div class="modal-dialog modal-lg" >
            <div class="modal-content ">
               <div class="modal-header blue_bg">
                  ...
                  <h4 class="modal-title white"><i class="fa fa-pencil-square-o"></i>Add Top Featured For Homestay</h4>
               </div>
               <form id="locationForm" method="post" action="<?php echo base_url(); ?>Admin/add_topFeature">
                  <div class="modal-body">
                      <div class="col-md-12">
                        <input type="hidden" name="property_type" id="property_type" value="HomeStay">
                           <div class="col-md-6">
   ...
   $(function() {
      ...
      {  
            ...
            $.ajax({
                ...
                url:"<?php echo base_url(); ?>Admin/get_topFeature/HomeStay",
                method:"POST",
