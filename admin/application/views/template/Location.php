                     ...
                     <div class="box">
                        <div class="box-header">
                           ...
                           <table>
                              ...
                              <h3 class="box-title pull-left"><i class="fa fa-user"></i> Locations</h3>
                           </div>
                           <div class="col-md-6">
         ...
         <div class="modal-dialog modal-lg" >
            <div class="modal-content ">
               <div class="modal-header blue_bg">
                  ...
                  <h4 class="modal-title white"><i class="fa fa-pencil-square-o"></i>Add Location</h4>
               </div>
               <form id="locationForm" method="post" action="<?php echo base_url(); ?>Admin/put_location">
                  <div class="modal-body">
                      <div class="col-md-12">
                           <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Title:</label>
                                        <input type="text" name="location_title" class="form-control" placeholder="Name" required="required">
                                    </div>
                           </div>
                           <div class="col-md-6">
                           <div class="form-group">
                                        <label>Property Type:</label>
                                        <select class="form-control" id="" name="PropertyType" required="required">
