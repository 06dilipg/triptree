    ...
    <aside class="right-side">
            ...
            <section class="content-header">
               <ol class="breadcrumb">
                  ...
                  <li><i class="fa fa-dashboard"></i> Property Details </li>
                        ...
                        <div class="col-xs-12">
                           <div class="box">
                              <div class="box-header">
                                 <h3 class="box-title"><b> <i class="fa fa-envelope" style="font-size:17px;"></i> Property Details</b></h3>
        ...
        $(function() {
            ...
            {  
                    ...
                    $.ajax({
                        ...
                        url:"<?php echo base_url(); ?>Admin/view_Property?id=<?php echo $id;?>",
                        method:"POST",
