                  ...
                  <div class="col-xs-12">
                     <div class="box">
                        <div class="box-header">
                           <div class="col-md-6 ">
                              <h3 class="box-title pull-left"><i class="fa fa-list" style="font-size:17px;"></i>Home Stay Enquiry Details</h3>
                           </div>
                         <!--   <div class="col-md-6">
      ...
      {  
         //   alert(1);
            $.ajax({
                ...
                url:"<?php echo base_url(); ?>Admin/get_Enquiry/HomeStay",
                method:"POST",
                success:function(data){
         ...
         $(document).on('click', '.delete', function(){  
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url(); ?>Admin/delete_Enquiry",  
                     method:"POST",  
