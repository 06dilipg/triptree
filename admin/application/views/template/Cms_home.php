                  ...
                  <div class="col-xs-12">
                     <div class="box">
                        <div class="box-header">
                           <div class="col-md-6 ">
                              <h3 class="box-title pull-left"><i class="fa  fa-picture-o"></i> Home Page</h3>
                           </div>
                           <div class="col-md-6">
      ...
      <div class="modal fade" id="add-modal"  role="dialog">
         <div class="modal-dialog modal-lg" >
            <div class="modal-content ">
               ...
               <form id="addHome" method="POST" action="<?php echo base_url(); ?>Admin/add_homecms" enctype="multipart/form-data">
         ...
         $(function() {
            ...
            {  
                  ...
                  $.ajax({
                      ...
                      url:"<?php echo base_url(); ?>Admin/get_cmshome",
                      method:"POST",
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url(); ?>Admin/delete_cmshme",  
                     method:"POST",  
