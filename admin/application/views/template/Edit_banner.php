<aside class="right-side">
            ...
            <section class="content-header">
               <ol class="breadcrumb">
                  ...
                  <li><i class="fa fa-dashboard"></i> Edit Banner </li>
            ...
            <section class="content">
               <div class="row">
                        ...
                        <div class="col-xs-12">
                           <div class="box">
                              <div class="box-header">
                                 <h3 class="box-title"><b><i class="fa fa-edit"></i> Edit Banner</b></h3>
                                 <div class="box-tools pull-right">
                                    <a href="<?php echo base_url();?>Banner_slider">  <button class="btn bg-navy btn-social" style="margin-top:5px;"><span><i class="fa fa-step-backward" aria-hidden="true"></i>  Back</span></button></a>
                                 </div>
                              </div>
                               <?php $id = $_GET['id'];  ?>
                              <!-- /.box-header -->
                              <div class="box-body clearfix">
                                 <form id="edit_Content" enctype="multipart/form-data" action="<?php echo base_url(); ?>Admin/update_banner?id=<?php echo $id;?>" method="Post">
                  ...
                  <span id="Slider_image1" style="color: red;"></span>
           ...
           CKEDITOR.replace('editor1');
            ...
            {  
                  ...
                  $.ajax({
                              ...
                              url:"<?php echo base_url(); ?>Admin/fetch_banner?id=<?php echo $id;?>",
                              method:"POST",
                              dataType:"json",
                           
                                  success:function(data){
                                            $('#title').val(data.banner_title);
                                            $("#editor1").val(data.banner_description);
                                             $("#Slider_image").html(data.img);
