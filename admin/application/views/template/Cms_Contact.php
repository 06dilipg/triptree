                  ...
                  <div class="col-xs-12">
                     <div class="box">
                        <div class="box-header">
                           <div class="col-md-6 ">
                              <h3 class="box-title pull-left"><i class="fa  fa-picture-o"></i> Contact Us Page</h3>
                           </div>
                           <div class="col-md-6">
         ...
         <div class="modal-dialog modal-lg" >
            <div class="modal-content ">
               <div class="modal-header blue_bg">
                  ...
                  <h4 class="modal-title white"><i class="fa fa-pencil-square-o"></i> Contact Us Page</h4>
               </div>
               <form id="addHome" method="POST" action="<?php echo base_url(); ?>Admin/add_Contactcms" enctype="multipart/form-data">
                        ...
                        <label>Phone Number:</label>
                             <div class='box-body'>
                                 <table class="table table-bordered" id="dynamic_field">  
                                    <tr>  
                                         <td><input type="text" name="name[]" placeholder="Enter Phone Number" class="form-control name_list" /></td>  
         ...
         $(function() {
            ...
            {  
                  ...
                  $.ajax({
                      ...
                      url:"<?php echo base_url(); ?>Admin/get_cmsContact",
                      method:"POST",
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url(); ?>Admin/delete_cmsContact",  
                     method:"POST",  
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="name[]" placeholder="Enter Phone Number" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  
