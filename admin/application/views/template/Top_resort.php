         ...
         <aside class="right-side">
            ...
            <section class="content-header">
               ...
               <ol class="breadcrumb">
                  ...
                  <li class="active">Top Featured Resort</li>
               </ol>
            </section>
            <!-- Main content -->
                     ...
                     <div class="box">
                        <div class="box-header">
                           ...
                           <table>
                              ...
                              <h3 class="box-title pull-left"><i class="fa fa-user"></i> Top Featured Resort</h3>
                           </div>
                           <div class="col-md-6">
         ...
         <div class="modal-dialog modal-lg" >
            <div class="modal-content ">
               <div class="modal-header blue_bg">
                  ...
                  <h4 class="modal-title white"><i class="fa fa-pencil-square-o"></i>Add Top Featured For Resort</h4>
               </div>
                      ...
                      <div class="col-md-12">
                           ...
                           <div class="col-md-6">
                                    <div class="form-group">
                                       <input type="hidden" name="property_type" id="property_type" value="Resort">
   ...
   $(function() {
      ...
      {  
            ...
            $.ajax({
                ...
                url:"<?php echo base_url(); ?>Admin/get_topFeature/Resort",
                method:"POST",
            ...
            {  
               // alert('s');
                  $.ajax({
                     ...
                     url:"<?php echo base_url(); ?>Admin/get_place/Resort",
                     method:"POST",
                     success:function(data){
