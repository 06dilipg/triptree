                  ...
                  <div class="col-xs-12">
                     <div class="box">
                        <div class="box-header">
                           <div class="col-md-6 ">
                              <h3 class="box-title pull-left white"><i class="fa fa-gift"></i> All  Coupon Code</h3>
                           </div>
                           <div class="col-md-6">
            ...
            <div class="modal-dialog modal-lg" >
                <div class="modal-content ">
                    <div class="modal-header blue_bg">
                        ...
                        <h4 class="modal-title white"><i class="fa fa-pencil-square-o"></i> Coupon Code details</h4>
                    </div>
                    <form action="#" method="post">
                        <div class="modal-body">
                                <div class="form-group">
                                    <label>Coupon Code:</label>
                                        <input type="text"  class="form-control" Value="788">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <label>Expiry Date:</label>
                                        <input type="text"  class="form-control" Value="03/02/2019">
                                    </div>
