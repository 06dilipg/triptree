                  ...
                  <div class="col-xs-12">
                     <div class="box">
                        <div class="box-header">
                           <div class="col-md-6 ">
                              <h3 class="box-title pull-left"><i class="fa  fa-table white" aria-hidden="true"></i> Footer Content</h3>
                           </div>
                           <div class="col-md-6">
         ...
         <div class="modal-dialog modal-lg" >
            <div class="modal-content ">
               <div class="modal-header blue_bg">
                  ...
                  <h4 class="modal-title white"><i class="fa fa-pencil-square-o white"></i> Footer Content</h4>
               </div>
