                  ...
                  <div class="col-xs-12">
                     <div class="box">
                        <div class="box-header">
                           <div class="col-md-6 ">
                              <h3 class="box-title pull-left"><i class="fa  fa-picture-o"></i> Edit Sliders</h3>
                           </div>
                           <div class="col-md-6">
                           ...
                           <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td class="box-tools">
                                       <a href="#edit-modal" data-toggle="modal" class="btn btn-app btn-sm"><i class="fa fa-edit"></i></a>
